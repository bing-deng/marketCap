...
if __name__ == "__main__":
    ...
    try:
        # stellar xml
        coin_list = ["bitcoin", "bitcoin-cash", "ethereum","litecoin","xrp", "monacoin", "ethereum-classic","nem","lisk","qash","counterparty","horizen","tether", "binance-coin", "eos", "bitcoin-sv","dogecoin","stellar","cardano","qtum","factom","polkadot-new"]
        ...
        # coin_list = ["binance-coin", "eos", "bitcoin-sv","dogecoin","stellar","cardano","qtum","factom"]
        # coin_list = ['xrp','polkadot-new',"qtum","factom"]
        # coin_list = ["xrp"]
